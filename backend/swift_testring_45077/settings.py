"""
Django settings for swift_testring_45077 project.
...
ROOT_URLCONF = 'swift_testring_45077.urls'
...
WSGI_APPLICATION = 'swift_testring_45077.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "swift_testring_45077 API",
    "DESCRIPTION": "API documentation for swift_testring_45077 App",
    "VERSION": "v1",
}
